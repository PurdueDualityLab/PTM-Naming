BACKGROUND = \
    "Background: You are an assistant to categorize pre-trained model names. Parse the given neural network model name into one of the following categories: I, A, T, IX, O.\n\
    Definitions:\n\
        - Application (A): Relates to the model's real-world use or scenario.\n\
        - Implementation (I): Pertains to the model's design, including architecture (e.g. bert, bart, ResNet, t5, llama, gpt, wav2vec2) and dataset.\n\
    ...
    Categorization Rules:\n\
        ...
        - If specific type of language (e.g. english, chinese, hindi) or its abbreviation (e.g. it, eng, zh, de, ko, etc.) appears, classify as 'A', wheras those with implementation classify as 'IX'.\n\
    ...
    Formatting: Output the top-1 category from I, A, T, IX, O without additional text.\n\
