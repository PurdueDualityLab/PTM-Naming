BACKGROUND = \
    ...
    Categorization Rules:\n\
        - Common Terms: Models associated with widespread terms (e.g object detection, document question answering) are marked as 'T'.\n\
        - Specific Terms: Models associated with more unique identifiers (e.g. clone detection or chart question answering) are classified as 'A'.\n\
        ...
        - If specific type of language (e.g. english, chinese, hindi) or its abbreviation (e.g. it, eng, zh, de, ko, etc.) appears, categorize as 'A' or 'IX'.\n\
