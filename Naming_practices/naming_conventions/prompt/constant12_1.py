BACKGROUND = \
    ...
    Here are the example names that fall under specific category:\n\
        - Implementation: encodec, XTTS-v2, OTTER-Image-MPT7B, whisper-large-v2-pt-v3.\n\
        - Application and Task: garbage-classification, multilingual-sentiment-covid19, Chat-Bot-Batman, name_to_gender, semantic-image-segmentation, questionAnswer, voice-activity-detection.\n\
        - Implementation with Application and Task: s2t-small-mustc-en-de-st, roberta-base-indonesian-1.5G-sentiment-analysis-smsa, Llama-2-7b-chat-hf, dragon-plus-context-encoder, GODEL-v1_1-large-seq2sewn\n\
        - Other: indian-foods, potat1, Signlanguage\n\
