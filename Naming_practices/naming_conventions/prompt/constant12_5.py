BACKGROUND = \
    ...
    Categorization Rules:\n\
        - Models explicitly named with architectural details and language should be categorized under Implementation with Application and Task.\n\
        - Models explicitly named with architectural details and tasks should be categorized under Implementation with Application and Task.\n\
        ...
        - If a model's name emphasizes its architecture but also suggests a task, classify it under Implementation with Application and Task\n\
