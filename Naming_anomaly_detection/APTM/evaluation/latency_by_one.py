...
def export_vector(repo_name):
    ...
    json_file_loc_aptm = os.path.join(PEATMOSS_PATH, "aptm_final")
    json_file_loc_vec = os.path.join(PEATMOSS_PATH, "vector_final")
...
def main():
    ...
    json_file_loc_latency = Path(PEATMOSS_PATH) / "latency_final.json"
    json_file_loc_params = Path(PEATMOSS_PATH) / "params_final.json"
